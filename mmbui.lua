...
function WazureV1:Start(GuiConfig)
    ...
    Blur.Size = 18
    Blur.Name = "UIConfirmBlur"

    -- Nếu Lighting không tồn tại, bỏ qua Blur
    pcall(function()
        Blur.Parent = game:GetService("Lighting")
    end)

    -- Kiểm tra nếu AzuGui tồn tại
    if not AzuGui or not AzuGui.Parent then
        warn("AzuGui not found")
        return
    end
    ...
    ConfirmFrame.Size = UDim2.new(0, 270, 0, 140)
    ConfirmFrame.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
    ConfirmFrame.Parent = AzuGui
    ...
    YesButton.BackgroundColor3 = Color3.fromRGB(21, 21, 21)
    YesButton.Size = UDim2.new(0, 100, 0, 36)
    YesButton.Position = UDim2.new(0, 25, 1, -55)
    ...
    NoButton.Size = UDim2.new(0, 100, 0, 36)
    NoButton.Position = UDim2.new(1, -125, 1, -55)
    ...
    -- Hover hiệu ứng
    local function Hover(btn, hover, normal)
    ...
    Hover(YesButton, Color3.fromRGB(35,35,35), Color3.fromRGB(21,21,21))
    Hover(NoButton, Color3.fromRGB(90,90,90), Color3.fromRGB(70,70,70))

    -- Hành động nút
    YesButton.Activated:Connect(function()
        pcall(function() Blur:Destroy() end)
        AzuGui:Destroy()
        if GuiConfig and GuiConfig.CloseCallBack then
