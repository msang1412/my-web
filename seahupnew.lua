...
SettingsButton.MouseButton1Click:Connect(function()
	...
	local hoverColor = Color3.new(
		math.clamp(originalColor.R * 1.25, 0, 1),
		math.clamp(originalColor.G * 1.25, 0, 1),
		math.clamp(originalColor.B * 1.25, 0, 1)
	)
	...
	function newButtonFunctions:SetButtonColor(color)
		...
		hoverColor = Color3.new(
			math.clamp(color.R * 1.25, 0, 1),
			math.clamp(color.G * 1.25, 0, 1),
			math.clamp(color.B * 1.25, 0, 1)
		)
	end
